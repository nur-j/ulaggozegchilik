...
@section('content')
  ...
  <div class="card card-primary mx-3">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form role="form" method="POST" action="{{ route('save_post') }}" enctype="multipart/form-data">
      @csrf
      <div class="card-body">
            ...
            <div class="tab-content" id="custom-tabs-one-tabContent">
              <div class="tab-pane fade active show" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                ...
                <div class="form-group">
                  ...
                  <textarea name="description_tm" class="form-control summernote" id="description_tm"></textarea>
                </div>
              </div>
              <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
                ...
                <div class="form-group">
                  ...
                  <textarea name="description_ru" class="form-control summernote" id="description_ru"></textarea>
                </div>
              </div>
              <div class="tab-pane fade" id="custom-tabs-one-messages" role="tabpanel" aria-labelledby="custom-tabs-one-messages-tab">
                ...
                <div class="form-group">
                  ...
                  <textarea name="description_en" class="form-control summernote" id="description_en"></textarea>
                </div>
              </div>
            </div>
          </div>
