...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('admin_panel') }}" class="brand-link">
      <img src="{{ asset('assets/awtoulag_logo.svg') }}" alt="Awtoulag Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Ulaggözegçilik</span>
    </a>
  ...
  <footer class="main-footer">
    <strong> &copy; 2022 <a href="http://ulaggozegchilik.gov.tm">ulaggozegchilik.gov.tm</a></strong>
    {{-- All rights reserved. --}}
  </footer>
